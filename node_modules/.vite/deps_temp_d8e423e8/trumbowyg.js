...
(function(navigator2, window2, document2, $) {
  ...
  var Trumbowyg = function(editorElem, options) {
    ...
    var baseHref = !!t.doc.querySelector("base") ? window2.location.href.split(/[?#]/)[0] : "";
  ...
  Trumbowyg.prototype = {
    ...
    destroy: function() {
      ...
      if (t.isTextarea) {
        ...
        t.$box.after(
          t.$ed.css({ height: "" }).removeClass(prefix + "editor").removeAttr("contenteditable").removeAttr("dir").html(t.html()).show()
        );
      }
    ...
    createLink: function() {
      var t = this, documentSelection = t.doc.getSelection(), selectedRange = documentSelection.getRangeAt(0), node = documentSelection.focusNode, text = new XMLSerializer().serializeToString(selectedRange.cloneContents()) || selectedRange + "", url, title, target;
    ...
    updateButtonPaneStatus: function() {
      var t = this, prefix = t.o.prefix, activeClasses = prefix + "active-button " + prefix + "active", originalIconClass = prefix + "original-icon", tags = t.getTagsRecursive(t.doc.getSelection().focusNode);
      t.clearButtonPaneStatus();
    ...
    getTagsRecursive: function(element, tags) {
      ...
      tags.push(tag);
      return t.getTagsRecursive(element, tags).filter(function(tag2) {
        return tag2 != null;
      });
    },
    // Plugins
